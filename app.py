...
body_app = dbc.Container([
        ...
        dbc.Row([html.Div([
            html.P('No momento eu procuro estas palavras-chave JORNALISMO, JORNALISTA, JORNALISTAS, COMUNICADORES, IMPRENSA, VERIFICADORES DE FATOS, CHECAGEM DE FATOS, FAKE NEWS, DESINFORMAÇÃO, TRANSPARÊNCIA NA INTERNET, LIBERDADE DE EXPRESSÃO, ONGs E INFORMAÇÕES DE INTERESSE COLETIVO.')         
        ])
        ]),
